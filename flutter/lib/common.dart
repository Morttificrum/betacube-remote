...
import 'package:betacube_remote/utils/platform_channel.dart';
...
import 'package:betacube_remote/native/win32.dart'
    if (dart.library.html) 'package:betacube_remote/web/win32.dart';
import 'package:betacube_remote/native/common.dart'
    if (dart.library.html) 'package:betacube_remote/web/common.dart';
...
class MyTheme {
  ...
  static const Color accent50 = Color(0x7722D3EE);
  static const Color accent80 = Color(0xAA22D3EE);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Color(0xFF1E50D2), secondary: accent, background: grayBg),
