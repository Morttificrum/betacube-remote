...
import 'package:betacube_remote/common/widgets/audio_input.dart';
import 'package:betacube_remote/common/widgets/setting_widgets.dart';
...
import 'package:betacube_remote/mobile/widgets/dialog.dart';
...
import 'package:betacube_remote/plugin/widgets/desktop_settings.dart';
...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About Beta Cube Remote'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://betacube.com.br');
                  },
                  child: Text(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Beta Cube Soluções em TI.\n$license',
