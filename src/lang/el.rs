...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Γλώσσα"),
        ("Keep Beta Cube Remote background service", "Διατήρηση της υπηρεσίας παρασκηνίου του Beta Cube Remote"),
        ...
        ("About Beta Cube Remote", "Πληροφορίες για το Beta Cube Remote"),
