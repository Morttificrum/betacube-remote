...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Idioma"),
        ("Keep Beta Cube Remote background service", "Manter o serviço do Beta Cube Remote executando em segundo plano"),
        ...
        ("About Beta Cube Remote", "Sobre o Beta Cube Remote"),
